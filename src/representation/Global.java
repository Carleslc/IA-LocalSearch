...
public class Global {
    ...
    private static final int TRUCKS_PER_DISTRIBUTION_CENTER = 1;
    ...
    public static final int MAX_TRIPS_PER_DAY = 5;
    public static final int ASIGNATIONS_PER_TRIP = 2; // number of tanks a truck can carry
